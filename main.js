...
import { initUserCards, handleMarketCreatePage, initStatsButtons, initPackPage, initOwnerDirectTrade, initTradeOfferAutoSelect, initTradeOfferFilters } from './contextHandlers.js';
        ...
        try {
            ...
            try {
                 switch (context) {
                      ...
                      case 'cardOwners': initOwnerDirectTrade(); break;
                      case 'deckView':
                         if (shouldProcessCards) {
                      ...
                      case 'tradeOffer': 
                          ...
                          initTradeOfferAutoSelect(); // Автоматический выбор карты
                          initTradeOfferFilters(); // Отслеживание фильтров по рангам
                          break;
                      case 'remelt':
                      case 'market':
                      case 'split':
